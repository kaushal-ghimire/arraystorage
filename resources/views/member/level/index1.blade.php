    ...
    <div class="page-body">
        <div class="row">
                                  ...
                                  <div class="modal-body">
                                    <form method="POST" action="{{route('level.store')}}">
                                        ...
                                        <div class="form-group">
                                            <label for="level" class="col-form-label">Level Name:</label>
                                            <input oninput="this.value = this.value.toUpperCase()" type="text" class="form-control" name="level" required>
                                        </div>
                                        <div class="form-group">
            ...
            <div class="dt-responsive table-responsive">
                <table id="list-level-table" class="table table-hover table-bordered dt-responsive nowrap" style="width: 100%">
                    <thead>
                        <tr>
                            <th>SN</th>
                            <th>Level Name</th>
...
<script>
    $(document).ready(function() {
        var dataTable = $('#list-level-table').DataTable({
            "searching":true,
            "ordering":true,
            "processing": true,
            "serverSide": true,
            ...
            { data: 'level', name: 'level', title: 'Level Name'  , orderable: true,searchable: true},
