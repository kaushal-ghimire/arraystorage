    ...
    <div class="page-body">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="row">
                            <div class="col-12">
                                <!-- <a href="{{ route('unit.create') }}" class="btn btn-sm btn-primary float-right">Add Unit</a> -->
            ...
            <div class="dt-responsive table-responsive">
                <table id="list-units-table" class="table table-hover table-bordered dt-responsive nowrap" style="width: 100%">
                    <thead>
                        <tr>
                            <th>SN</th>
                            <th>Name</th>
...
<script>
    $(document).ready(function() {
        var dataTable = $('#list-units-table').DataTable({
            "searching":true,
            "ordering":true,
            "processing": true,
            "serverSide": true,
                    ...
                    $.ajax({
                        ...
                        success: function(response){
                            ...
                            Swal.fire({
                                ...
                                $('#list-units-table').DataTable().ajax.reload();
                            });
                        }
                    });
