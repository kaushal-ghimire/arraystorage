            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Sub-Category
                        </a> </li>
                    </ul>
                </div>
            </div>
                        ...
                        <form method="POST" action="{{route('subcategory.update',$subcategories->id)}}" enctype="multipart/form-data">
                         ...
                         @method("PATCH")
                            <div class="form-group row has-error">
                                ...
                                <label class="col-sm-2 col-form-label">SubCategory Name <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input oninput="this.value = this.value.toUpperCase()" type="text"  name="name" class="form-control" value="{{$subcategories->name}}">
