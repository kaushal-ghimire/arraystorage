...
<div class="page-wrapper">
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>List of Cancelled Orders</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <!-- Page-header end -->
                        ...
                        <div class="table-responsive">
                            <table id="cancelled-order-table" class="table table-hover table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Bill_Id</th>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#cancelled-order-table').DataTable({
                "searching" : true,
                "processing": true,
                dom: 'Bfrtip',
