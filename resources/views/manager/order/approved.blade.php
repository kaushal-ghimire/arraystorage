...
<div class="page-wrapper">
    ...
    <!-- Page-header end -->
                        ...
                        <div class="table-responsive">
                            <table id="approved-order-table" class="table table-hover table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>Bill_Id</th>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#approved-order-table').DataTable({
                "searching" : true,
                "processing": true,
                dom: 'Bfrtip',
