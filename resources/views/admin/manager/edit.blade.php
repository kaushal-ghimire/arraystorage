            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form id="main" method="POST" action="{{route('manager.update',$manager->id)}}" enctype="multipart/form-data" novalidate="">
                            @csrf
                            ...
                            <div class="form-group row has-error">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control @error('avatar') input-danger @enderror" name="avatar" value="{{$manager->avatar }}" id="avatar">
