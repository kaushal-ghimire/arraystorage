...
<div class="page-wrapper">
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>List of Approved Payments</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <!-- Page-header end -->
                        ...
                        <div class="table-responsive">
                            <table id="approved-payment-table" class="table table-hover table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Id</th>
                                        <th>User_Id</th>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#approved-payment-table').DataTable({
                "searching" : true,
                "processing": true,
                dom: 'Bfrtip',
