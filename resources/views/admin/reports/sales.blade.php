                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="list-sale-table" class="table table-hover table-bordered dt-responsive nowrap" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>Product</th>
                                        <th>Product_Id</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#form1,#form2,#form3').on('keyup',function() {
            ...
            $('#list-sale-table').DataTable().destroy();
        ...
        {
            var dataTable = $('#list-sale-table').DataTable({
                ...
                "columns": [
                    ...
                    { data: 'user_id', title: 'Entered By', orderable: false, searchable: true},
                    { data: 'category', title: 'Category', orderable: true, searchable: true},
                    { data: 'quantity', title: 'Sold Qty', orderable: true,searchable: false},
                    { data: 'rate', title: 'Rate', orderable: true, searchable: false},
                    { data: 'total', title: 'Total', className:'sold',orderable: false, searchable: false},
            ...
            // dataTable.column(7).data().sum();
            $('#list-sale-table').on('draw.dt', function () {
