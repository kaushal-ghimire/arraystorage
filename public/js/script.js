...
function myMarginFunction() {
    ...
    var checkBox = document.getElementById("myMarginCheck");
    var text = document.getElementById("text");
    
    if (checkBox.checked == true){
        text.style.display = "inline-block";
        array.forEach(element => {
            $(".sell").val($(".quan").val() * $(".p_price").val() + $(".checker .form-control").val());
        });
    }else {
            text.style.display = "none";
            $(".margin-percent").val(0);
            $(".sell").val($(".quan").val() * $(".p_price").val()/ $(".quan").val() + $(".vat-amount .form-control").val()  + $(".delivering .form-control").val());
        }
}


//js->delivery checkbox
function myDeliveryFunction() {
    var mydeliveryCheck = document.getElementById("myDeliveryCheck");
    var text1 = document.getElementById("text1");
    if (mydeliveryCheck.checked == true){
        text1.style.display = "inline-block";
        array.forEach(element => {
            $(".sell").val($(".quan").val() * $(".p_price").val() + $(".checker .form-control").val() + $(".delivering .form-control").val()); 
        }); 

    }else {
            text1.style.display = "none";
            $(".delivered").val(0);
            $(".sell").val(($(".quan").val() * $(".p_price").val() + $(".checker .form-control").val())/$(".quan").val());      
        }
}

//js->delivery checkbox
function myDiscountFunction() {
    var mydiscountCheck = document.getElementById("mydiscountCheck");
    var text2 = document.getElementById("text2");
    if (mydiscountCheck.checked == true){
        text2.style.display = "inline-block";
        array.forEach(element => {
            $(".sell").val($(".quan").val() * $(".p_price").val() + $(".checker .form-control").val() + $(".delivering .form-control").val() - $(".discounting .form-control").val()); 
        });

    }else {
            text2.style.display = "none";
            $(".discounted").val(0);
            $(".sell").val((($(".quan").val() * $(".p_price").val())/$(".quan").val()) + $(".check .form-control").val() + $(".delivering .form-control").val()); 
        }
}
//js -> vat function
function myVatFunction() {
    
    var myVatCheck = document.getElementById("myVatCheck");
    var text3 = document.getElementById("text3");
    if (myVatCheck.checked == true){
        text3.style.display = "inline-block";
        $(".vat-amt").val(13);
        array.forEach(element => {
              $(".purchase").val($(".quantity").val() * $(".p_price").val() + $(".vat .form-control").val()); 
        });
    }else {
            text3.style.display = "none";
            $(".vat-amt").val(0);
            $(".purchase").val($(".quantity").val() * $(".p_price").val());
        }
}

function myVatFunction1() {
    var myVatCheck1 = document.getElementById("myVatCheck");
    var text3 = document.getElementById("text3");
    if (myVatCheck1.checked == true){
        text3.style.display = "inline-block";
        $(".vat-amt").val(13);
        array.forEach(element => {
            $(".sell").val($(".quan").val() * $(".p_price").val() + $(".vat .form-control").val());
        });
    }else {
            text3.style.display = "none";
            $(".vat-amt").val(0);
            $(".sell").val($(".quan").val() * $(".p_price").val()/$(".quan").val());
        }
}
...
function toggleFullScreen() {
    ...
    {
        //for purchase
       var purchase_quantity = Number(document.getElementById('quantity').value);
       var price_pcs = Number(document.getElementById('p_price').value);
       var tot_price = purchase_quantity * price_pcs;
       document.getElementById('tot_price').value = tot_price;
       var vat_percent = Number(document.getElementById('vat').value);
       var purchase_withVat = tot_price + ((vat_percent/100)*tot_price);
       document.getElementById('tot_price').value = purchase_withVat;
       
    }

    // function calculateSell(){
    //     //for selling
    //     var purchase_quan = Number(document.getElementById('quantity').value);
    //     var price_piece = Number(document.getElementById('p_price').value);
    //     var total_price = purchase_quan * price_piece;
    //     document.getElementById('tot_price').value = total_price; 
    //    var sell_quan = Number(document.getElementById('sell_quan').value);
    //    var sp = total_price / sell_quan;
    //    var vat_percent = Number(document.getElementById('vat').value);
    //    var sp_withVat = sp + ((vat_percent/100)*sp);
    //    var margin = Number(document.getElementById('margin1').value);
    //    var marginal_value = (margin/100)*sp;
    //    var discount = Number(document.getElementById('discount').value);
    //    var discount_value = (discount/100)*sp;
    //    var delivery_value = Number(document.getElementById('delivery').value);
